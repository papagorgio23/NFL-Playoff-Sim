...
### Functions needed for the modeling
...
# Set number of simulations at 1,000,001
num_sims <- 1000001
i <- 1
...
This cycles through each game all the way through to the Super Bowl. It keeps track of how far each team made it each time. 
